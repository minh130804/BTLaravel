...
<head>
    <meta charset="utf-8">
    <title>Minh Đẹp Trai - Cửa Hàng</title>
            ...
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold"><span
                            class="text-primary font-weight-bold border px-3 mr-1">M</span>inh Đẹp Trai</h1>
                </a>
            </div>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            <a href="{{ route('login') }}" class="nav-item nav-link text-primary">Đăng Nhập Quản Trị</a>
                        </div>
                    </div>
                </nav>
                        ...
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">Giảm 10% Đơn Đầu Tiên
                                    </h4>
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Thời Trang Phong Cách
                                    </h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4 h-100">
                        ...
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3 px-2" title="{{ $product->name }}">{{ $product->name }}</h6>
            ...
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="mb-4 display-5 font-weight-semi-bold"><span
                            class="text-primary font-weight-bold border border-white px-3 mr-1">M</span>inh Đẹp Trai
                    </h1>
                </a>
                <p>Cửa hàng chuyên cung cấp các sản phẩm thời trang, phụ kiện chất lượng cao với giá cả hợp lý nhất thị
                    trường.</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>55 Giải Phóng, Hà Nội</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>lienhe@minhdeptrai.com</p>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-dark" href="#"><i class="fa fa-angle-right mr-2"></i>Liên Hệ</a>
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
                        <h5 class="font-weight-bold text-dark mb-4">Chính Sách</h5>
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-dark mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Chính sách bảo
                                mật</a>
                            <a class="text-dark mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Chính sách đổi
                                trả</a>
                            <a class="text-dark mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Quy định giao
                                hàng</a>
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    &copy; <a class="text-dark font-weight-semi-bold" href="#">Minh Đẹp Trai</a>. All Rights Reserved.
                </p>
            </div>
